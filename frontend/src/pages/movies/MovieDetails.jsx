        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-1/3">
            <img
              ...
              alt={movie?.name}
              className="w-full h-auto rounded-xl shadow-2xl border border-gray-700 object-cover"
            />
          </div>

          {/* Right Side: Details & Cast */}
          <div className="md:w-2/3">
            {/* Container One: Details & Cast */}
            <div className="flex flex-col lg:flex-row lg:justify-between border-b border-gray-700 pb-8">
